...
function Navbar() {
  ...
  return (
    <div className={'relative'}>
      ...
      >
        <div className={'navbar-header'}>
          <div
            className={`transition-all ease duration-300 navbar-avatar ${
              navbarExpended ? 'w-[100vw] justify-start' : 'justify-center'
        ...
        <div
          className={`navbar-footer transition-all ease-in-out duration-300 text-center flex flex-col justify-center gap-[10px] bg-white-400 border-t-[2px] border-t-black-100 ${
            navbarExpended ? 'h-0 opacity-0' : 'p-[10px] opacity-100'
          }`}
        >
      ...
      <button
        className={`w-[40px] h-[40px] flex items-center justify-center z-20 rounded-full bg-white-900 text-black-700 shadow-[0_10px_20px_rgba(0,0,0,0.1)] absolute backdrop-blur-[10px] top-[5.3rem] right-[-20px] transition-all linear duration-300 hover:bg-black-100 ${
