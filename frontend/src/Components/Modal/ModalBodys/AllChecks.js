...
function AllCheck() {
    const date = new Date()
    console.log("Data : " ,date.getUTCDate())
    ...
    const data = [
        ...
        {id: 3, sana : "25.07.2022", kodi : "101010" , maxsulot : "otvod 90 (40)", soni :1, narxi : "200 000 UZS", jami : "200 000 UZS"},
    ]
        ...
        <section className="w-[63.78rem] bg-white-900">
            ...
            <div>
                <ul className="check-ul-li border-b-[0.8px] border-black-700">
                    ...
                    <li >Sotuvchi: <span className="check-ul-li-span"></span> </li>  
                </ul>
            </div>
               
            <div className="mt-4">
                <h3 className="text-[1.3rem] text-black-700 pb-2 font-bold">Sotilganlar : </h3>
            ...
            <div className="border-t-[0.8px] border-black-700 w-full mt-3 text-end">
                <h3 className="text-[1.1rem] text-black-700 font-bold pt-1">Sotilganlar jami : <span>900 129 900 UZS</span></h3>
            </div> 

            <div>
                <h3 className="text-[1.3rem] text-black-700 pt-[1.875rem] font-bold pb-2">Qaytarilganlar : </h3>
                <table class="border-collapse border border-slate-400 w-full">
                <thead>
                    <tr>
                        <td className="check-table-rtr">№</td>
            ...
            <div className="border-t-[0.8px] border-black-700 w-full mt-3 text-end">
                <h3 className="text-[1.1rem] text-black-700 font-bold pt-1">Qaytarilganlar jami : <span>900 129 900 UZS</span></h3>
            </div> 
