        ...
        <div onClick={onClick} className='flex-[0_0_23.5%] cardStyle'>
            ...
            <div className='text-[.875rem] mt-[1rem] text-center'>
                ...
                <div className='numberCard items-center'>
                    ...
                    <span
                        className={'block p-[0.1rem_0.5rem] rounded-[4px] bg-primary-700'}>
                ...
                {debt > 0 && <div className='numberCard items-center'>
                    ...
                    <span
                        className={'block p-[0.2rem_0.5rem] rounded-[4px] bg-error-500'}>
                            {currencyType === 'UZS' ? debtUzs.toLocaleString('ru-Ru') : debt.toLocaleString('ru-Ru')}{' '}
                        <span>{currencyType}</span>
                        </span>
                </div>}
                {debt > 0 && <button
                    className={'mt-[1rem] p-[.5rem_1rem] rounded-[1rem] text-center bg-error-500 text-white-900 hover:bg-warning-500 duration-200 active:scale-95 shadow-[0_0_10px_rgba(255,255,255,0.2)] active:shadow-none'}
                    onClick={(e) => {
                        onClickPayDebt({
                            debt,
                            debtUzs,
