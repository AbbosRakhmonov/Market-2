        ...
        <div className='mainPadding'>
            ...
            <div className={`report-card ${redText ? 'text-xl' : 'text-lg'}`}>
                <div className='cards-number'>
                    <p className='number-paragraf'>{number1} {all ? currency : ''}</p>
                    <p className='text'>{text1}</p>
                </div>
                <div className='cards-number'>
                    <p className='number-paragraf'>{number2} {head ? currency : ''}</p>
                    <p>{text2}</p>
                </div>
                <div className='cards-number'>
                    <p className={`number-paragraf ${redText ? 'text-[red]' : ''}`}>{number3} {end ? currency : ''}</p>
                    <p>{text3}</p>
                </div>
            </div>
        </div>
