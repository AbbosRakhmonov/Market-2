            ...
            <div className="loginCircle relative flex items-center justify-center">
                ...
                <div
                    ...
                    <div className="logo-container w-[36.9%]">
                        <img src={Logo} className={'w-full pointer-events-none'} alt="Alo24 logo"/>
                    </div>
                    <form className={'w-full px-[20%]'}>
                        ...
                        <button
                            type={'submit'}
                            className={'w-[83.999999%] transition-all ease-in-out duration-200 disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center py-[10px] bg-loginButton text-white-900 font-semibold shadow-[0_4px_5px_rgba(0,0,0,0.15)] rounded-[4px] mx-auto block enabled:hover:bg-success-500 enabled:active:bg-success-600 enabled:active:shadow-none leading-[1.125rem]'}
                            onClick={handleClickSubmit} disabled={loading}>
                            {loading ? <span className={'animate-spin spinner mr-1'}></span> : "Kirish"}
                        </button>
                    </form>
                </div>
                <Timebar/>
