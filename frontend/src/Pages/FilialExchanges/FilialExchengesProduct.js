...
import {getFilialShopData, getExchangesFilterId, clearSearchedExchanges} from './FilialExchengesSlice'
...
function FilialExchangesProduct({id, currency}) { 
    ...
    const {shops, loading, total, totalSearched,searchedExchanges} = useSelector((state) => state.filialData)
