...
const AdminProduct = () => {
    ...
    const data = [
        {
            _id: 1,
            logo: <div className='pt-[3px] w-[3rem] h-[3rem]'><img src={Microsoft}
                                                                   className={'w-[3.5rem] h-[3.5rem]'}></img></div>,
            shopName: 'Microsoft',
        ...
        {
            _id: 2,
            logo: <div className='pt-[3px] w-[3rem] h-[3rem]'><img src={EPA} className={'w-[3.5rem] h-[3.5rem]'}></img>
            </div>,
            shopName: 'EPA',
            director: 'Sayyor',
            phone: '+9989 94 374 30 07',
